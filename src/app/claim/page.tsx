...
const ClaimPage = () => {
  ...
  const verifyUsername = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to verify username');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to claim tips. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh]">
        <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          ...
          {!isVerified ? (
            ...
            // Wallet connection and claim form
            <>
              {/* Tip Amount Display */}
              <div className="mb-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <p className="text-center text-gray-600 dark:text-gray-300">Available Tips</p>
